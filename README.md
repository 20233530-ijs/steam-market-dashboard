...
Steam Market Dashboard collects Steam game market data, gathers recent reviews, runs text analysis, and exposes the results through a FastAPI backend and a React TypeScript frontend dashboard.
...
- `src/`: React TypeScript frontend dashboard (Vite).
...
# Frontend
VITE_API_BASE_URL=https://steam-market-dashboard-production.up.railway.app
```
...
To serve the static dashboard from the project root:
